# Set Browser Options in Python Selenium Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can set browser-specific options for Python Selenium tests running on a real browser cloud. This sample shows how to configure browser options in Python Selenium on the TestMu AI cloud.
...
You can specify various browser-specific options in the test file capabilities. The following is an example of how to set Chrome-specific options using chromeOptions:
...
- For more information you can refer to the [TestMu AI blog on desired capabilities in Selenium testing](https://www.testmuai.com/blog/desired-capabilities-in-selenium-testing/).
